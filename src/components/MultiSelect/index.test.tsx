...
describe('MultiSelect component', () => {
  ...
  it('renders the multi-select component with options', async () => {
    render(
      <MultiSelect
        label="Cars"
        namespace="cars"
  ...
  it('expands the multi-select component when clicked', () => {
    render(
      <MultiSelect
        label="Cars"
        namespace="cars"
  ...
  it('expands and closes the multi-select component when navigating via keyboard', async () => {
    render(
      <MultiSelect
        label="Cars"
        namespace="cars"
  ...
  it('selects when navigating using a mouse', async () => {
    ...
    const options = await screen.getAllByTestId('multi-select-cars-option');
